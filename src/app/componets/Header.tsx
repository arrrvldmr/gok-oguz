  ...
  return (
    <header className="border-b-2 border-black bg-beige h-18">
      <div className="flex justify-center md:justify-between mx-auto container">
        ...
        <div
          className="flex px-3 lg:px-6 gap-2 lg:gap-8 bg-black text-white items-center grow-0 font-light text-sm lg:text-lg">
          <span
            onClick={() => i18n.changeLanguage('ro')}
            className={cn('cursor-pointer opacity-70 hover:opacity-100 transition duration-150 ease-out hover:ease-in hover:underline underline-offset-8', {
